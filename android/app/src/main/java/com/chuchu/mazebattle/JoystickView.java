...
public class JoystickView extends View implements Runnable {
    ...
    */
    ...
    //diagonalOffset
    private float diagonalOffsetBackground;
    private float diagonalOffsetButton;
    private float diagonalOffsetButtonBorder;
    ...
    public JoystickView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mVisible = styledAttributes.getBoolean(R.styleable.JoystickView_JV_visible, false);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // Draw the button as simple circle
            ...
            canvas.drawCircle(
                    getWidth() / 2 + mFixedCenterX - mCenterX,
                    getWidth() / 2 + mFixedCenterY - mCenterY,
                    mButtonRadius,
                    mPaintCircleButton
            );
        }
    ...
    protected void onSizeChanged(int w, int h, int oldW, int oldH) {
        ...
        diagonalOffsetBackground = (float) (mBackgroundRadius / 1.414);
        diagonalOffsetButton = (float) (mButtonRadius / 1.414);
        diagonalOffsetButtonBorder = (float) (mBorderRadius / 1.414);
        mPaintCircleButton.setShader( new LinearGradient(getWidth() / 2 + diagonalOffsetButton, getWidth() / 2 - diagonalOffsetButton, getWidth() / 2 - diagonalOffsetButton, getWidth() / 2 + diagonalOffsetButton,  getResources().getColor(R.color.white_30),  getResources().getColor(R.color.white_0), Shader.TileMode.CLAMP));
        mPaintCircleBorder.setShader( new LinearGradient(getWidth() / 2 + diagonalOffsetButtonBorder, getWidth() / 2 - diagonalOffsetButtonBorder, getWidth() / 2 - diagonalOffsetButtonBorder, getWidth() / 2 + diagonalOffsetButtonBorder,  getResources().getColor(R.color.white_30),  getResources().getColor(R.color.white_0), Shader.TileMode.CLAMP));
        mPaintBackground.setShader( new LinearGradient(getWidth() / 2 + diagonalOffsetBackground, getWidth() / 2 - diagonalOffsetBackground, getWidth() / 2 - diagonalOffsetBackground, getWidth() / 2 + diagonalOffsetBackground,  getResources().getColor(R.color.white_30),  getResources().getColor(R.color.white_0), Shader.TileMode.CLAMP));
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                //detect whether the position is valid
                if (mPosX > getWidth() * (1 - mButtonSizeRatio / 2 - mBackgroundSizeRatio / 2) || mPosX <  getWidth() * (mButtonSizeRatio / 2 + mBackgroundSizeRatio / 2)) {
                    mMovable = false;
                    return true;
                }
                if (mPosY > getWidth() * (1 - mButtonSizeRatio / 2 - mBackgroundSizeRatio / 2) || mPosY <  getWidth() * (mButtonSizeRatio / 2 + mBackgroundSizeRatio / 2)) {
                    mMovable = false;
                    return true;
                }
                mMovable = true;
                ...
                mPaintCircleButton.setShader( new LinearGradient(mPosX + diagonalOffsetButton, mPosY - diagonalOffsetButton, mPosX - diagonalOffsetButton, mPosY + diagonalOffsetButton,  getResources().getColor(R.color.white_70),  getResources().getColor(R.color.white_20), Shader.TileMode.CLAMP));
                mPaintCircleBorder.setShader( new LinearGradient(mPosX + diagonalOffsetButtonBorder, mPosY - diagonalOffsetButtonBorder, mPosX - diagonalOffsetButtonBorder, mPosY + diagonalOffsetButtonBorder,  getResources().getColor(R.color.white_70),  getResources().getColor(R.color.white_20), Shader.TileMode.CLAMP));
                mPaintBackground.setShader( new LinearGradient(mPosX + diagonalOffsetBackground, mPosY - diagonalOffsetBackground, mPosX - diagonalOffsetBackground, mPosY + diagonalOffsetBackground,  getResources().getColor(R.color.white_70),  getResources().getColor(R.color.white_20), Shader.TileMode.CLAMP));
    ...
    @Override // Runnable
    public void run() {
        while (!Thread.interrupted() && mVisible) {
            post(new Runnable() {
                public void run() {
                    if (mCallback != null)
                        mCallback.onMove(getAngle(), getStrength());
        ...
        while (!Thread.interrupted() && !mVisible) {
            reduce1 += 2 << 24;
            reduce2 += 1 << 24;
            mPaintCircleButton.setShader( new LinearGradient(getWidth() / 2 + diagonalOffsetButton, getWidth() / 2 - diagonalOffsetButton, getWidth() / 2 - diagonalOffsetButton, getWidth() / 2 + diagonalOffsetButton,  getResources().getColor(R.color.white_70) - reduce1,  getResources().getColor(R.color.white_20) - reduce2, Shader.TileMode.CLAMP));
            mPaintCircleBorder.setShader( new LinearGradient(getWidth() / 2 + diagonalOffsetButtonBorder, getWidth() / 2 - diagonalOffsetButtonBorder, getWidth() / 2 - diagonalOffsetButtonBorder, getWidth() / 2 + diagonalOffsetButtonBorder,  getResources().getColor(R.color.white_70) - reduce1,  getResources().getColor(R.color.white_20) - reduce2, Shader.TileMode.CLAMP));
            mPaintBackground.setShader( new LinearGradient(getWidth() / 2 + diagonalOffsetBackground, getWidth() / 2 - diagonalOffsetBackground, getWidth() / 2 - diagonalOffsetBackground, getWidth() / 2 + diagonalOffsetBackground,  getResources().getColor(R.color.white_70) - reduce1,  getResources().getColor(R.color.white_20) - reduce2, Shader.TileMode.CLAMP));
            invalidate();
            if (reduce2 == 51 << 24) return;
            try {
                Thread.sleep(mLoopInterval);
            } catch (InterruptedException e) {
                break;
